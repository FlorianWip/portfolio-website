...
<template>
  ...
  >
    <div class="flex flex-row h-full text-lg xl:text-xl items-center gap-14 py-auto mx-auto w-4/5 xl:w-2/3 justify-between">
      <span class="hidden xl:block hover:scale-110 cursor-pointer">© Florian Wippert (2024)</span>
      <span class="block xl:hidden hover:scale-110 cursor-pointer">© Florian Wippert</span>
