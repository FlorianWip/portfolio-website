...
<template>
  <div className="flex flex-col space-y-2">
    ...
    <span>Florian Wippert</span>
    <span className="pt-5 uppercase">Kontakt</span>
    <span>E-Mail: contact@florianwip.de</span>
    <span>Weitere Kontaktmöglichkeiten werden per Bedarf weitergegeben</span>
    <span className="pt-5">
      Quelle: <a href="https://www.e-recht24.de">https://www.e-recht24.de</a>
    </span>
  </div>
  <div className="flex flex-col text-justify space-y-2">
    ...
    <br> <b>Wer ist verantwortlich f&uuml;r die Datenerfassung auf dieser Website?</b>{' '}
    <p>
    ...
    <b>2. Allgemeine Hinweise und Pflicht&shy;informationen</b>
    Datenschutz
    <br>{' '}
    <p>
    ...
    <p>
      Florian Wippert
      <br>
      E-Mail: flammenfuchsyt@gmail.com
    </p>
    <p>
    ...
    <p>
      ...
      Einwilligung ist jederzeit widerrufbar. Sind Ihre Daten zur Vertragserf&uuml;llung oder zur
      Durchf&uuml;hrung vorvertraglicher Ma&szlig;nahmen erforderlich, verarbeiten wir Ihre Daten
      auf Grundlage des Art. 6 Abs. 1 lit. b DSGVO. Des Weiteren verarbeiten wir Ihre Daten,
      sofern diese zur Erf&uuml;llung einer rechtlichen Verpflichtung erforderlich sind auf
      Grundlage von Art. 6 Abs. 1 lit. c DSGVO. Die Datenverarbeitung kann ferner auf Grundlage
      unseres berechtigten Interesses nach Art. 6 Abs. 1 lit. f DSGVO erfolgen. &Uuml;ber die
      jeweils im Einzelfall einschl&auml;gigen Rechtsgrundlagen wird in den folgenden
    ...
    <b>3. Datenerfassung auf dieser Website</b>
    Server-Log-Dateien
    <br>{' '}
    <p>
    ...
    <p>
      ...
      YouTube keine Informationen &uuml;ber die Besucher auf dieser Website speichert, bevor
    ...
    <p>
      ...
      Seiten Sie besucht haben. Wenn Sie in Ihrem YouTube-Account eingeloggt sind,
      erm&ouml;glichen Sie YouTube, Ihr Surfverhalten direkt Ihrem pers&ouml;nlichen Profil
      zuzuordnen. Dies k&ouml;nnen Sie verhindern, indem Sie sich aus Ihrem YouTube-Account
      ausloggen.
    </p>{' '}
    <p>
    ...
    <p>
      ...
      Anbieter ist die Fonticons, Inc., 6 Porter Road Apartment 3R, Cambridge, Massachusetts,
      USA.
    </p>{' '}
    <p>
      ...
      Website aufgerufen wurde. Die Nutzung von Font Awesome erfolgt auf Grundlage von Art. 6
      Abs. 1 lit. f DSGVO. Wir haben ein berechtigtes Interesse an der einheitlichen Darstellung
      des Schriftbildes auf unserer Website. Sofern eine entsprechende Einwilligung abgefragt
      wurde, erfolgt die Verarbeitung ausschlie&szlig;lich auf Grundlage von Art. 6 Abs. 1 lit. a
      DSGVO und &sect; 25 Abs. 1 TTDSG, soweit die Einwilligung die Speicherung von Cookies oder
    ...
    <p>
      ...
      get&auml;tigte Mausbewegungen). Die bei der Analyse erfassten Daten werden an Google
      weitergeleitet.
    </p>{' '}
    <p>
